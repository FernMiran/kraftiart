...
if ( is_front_page() ) {
	...
	<div class="page-header inner-header-opacity">
		<div class="container">
			<div class="row kraftiart-page-title text-center align-items-center breadcrumb-items-center">
				<div class="col-sm-12">		
				<div class="tt-breadcrumb-title">
						<h2 class="title"><?php esc_html_e( 'Home', 'kraftiart' ); ?></h2>
					</div>
				</div>
			</div>
		</div>
	...
	<div class="container">
		<div class="row">
			...
			if( class_exists( 'ReduxFramework' ) && function_exists( 'loadmore_postSC' ) ) {
				...
				if( $kraftiart_options['blog-alignment'] == 'blog-right' ){
					get_template_part( 'template-parts/blog/blog', 'right' );
				}elseif( $kraftiart_options['blog-alignment'] == 'blog-left' ){
