	...
	<div class="site-branding d-flex align-items-center floadt-start w-100">
		<?php
			...
			elseif( $kraftiart_options['opt-logo'] == "1" ){
				...
				<div class="header-logo movil_logo"
				>
		...
		?>
			...
			/**
				 * Search
				 * quitar el if (false) para volver a poner la barra de eccommerce
 ...
 */                 
									...
									<div class="container">
										<div class="product-search">
											<form name="product-search" method="get" class="search-form search__form" action="<?php echo esc_url( home_url( '/' ) ); ?>">
												<div class="search-title float-start w-100">Inicia Tu Viaje Artístico</div>
		...
		<div class="wishlist-wrap">
			...
			<a href="<?php echo esc_url( home_url( '/' ) ); ?>wishlist" title="<?php esc_attr_e('wishlist','kraftiart'); ?>"  class="d-flex">
				<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#fff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-heart"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/></svg></a>
			</div>
	</div>
	<?php
					/**
					...
					if( class_exists( 'ReduxFramework' ) && function_exists( 'loadmore_postSC' ) ) { ?>
						<nav class="navbar-woocommerce">
							...
							<svg xmlns="http://www.w3.org/2000/svg" width="21" height="21" viewBox="0 0 24 24" fill="none" stroke="#fff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-user"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>
							</a>
